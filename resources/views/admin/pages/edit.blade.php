<x-admin-layout title="Edit Page - Admin">
    <main class="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                ...
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white">Edit Page</h2>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Update the page content and settings</p>
            </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" rows="10"
                                      class="w-full px-4 py-2 rounded-lg bg-white dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-primary/50">{{ old('content', $page->content) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            @if($page->featured_image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('storage/' . $page->featured_image) }}" alt="{{ $page->title }}" class="h-32 w-32 object-cover rounded-lg border border-gray-200 dark:border-gray-700">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <a href="{{ asset('storage/' . $page->featured_image) }}" target="_blank" class="text-primary hover:underline">View full size</a>
                                    </p>
                                </div>
                            @endif
