<x-admin-layout title="Edit Specification - Admin">
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-gray-900">Edit Specification</h1>
                <p class="mt-1 text-sm text-gray-600">Update specification information</p>
            </div>
                            ...
                            <div class="mt-5 md:mt-0 md:col-span-2">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="spec_name" id="spec_name" value="{{ old('spec_name', $specification->spec_name) }}" required
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <textarea name="description" id="description" rows="3"
                                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description', $specification->description) }}</textarea>
